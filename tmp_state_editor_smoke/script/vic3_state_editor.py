...
class Vic3StateEditorApp:
    ...
    def save_current(self) -> None:
        ...
        self.reload_repository(reselect_state=record.state_id, announce=False)
    ...
    def save_all(self) -> None:
        ...
        reselect_state = self.current_state_id
        self.reload_repository(reselect_state=reselect_state, announce=False)
